...
<head>
  ...
  <title>Dashboard &mdash; Stietit</title>
      ...
      <div class="main-sidebar">
        <aside id="sidebar-wrapper">
          <div class="sidebar-brand">
            <a href="index.php">lit.UI</a>
          </div>
          <div class="sidebar-brand sidebar-brand-sm">
            <a href="index.php">LUI</a>
          </div>
          <ul class="sidebar-menu">
            ...
            <li class="nav-item">
              <a href="pelamar.php" class="nav-link"><i class="fas fa-columns"></i> <span>Pelamar</span></a>
            </li>
          </ul>
        </aside>
      </div>
                ...
                <div class="card">
                  <div class="card-header">
                    ...
                    <div class="card-header-action">
                      <a href="pelamar.php" class="btn btn-danger">View More <i class="fas fa-chevron-right"></i></a>
                    </div>
                  </div>
                  <div class="card-body">
                        ...
                        <tbody>
                          ...
                          foreach ($org as $p) : ?>
                            <tr>
                              ...
                              <td><?= $p['email'] ?></td>
                              <td><?= $p['skill'] ?></td>
                              <td><a href="detail.php?id=<?= $p['id'] ?>" class="btn btn-info">Detail</a></td>
                            </tr>
                          <?php $i++;
                          endforeach; ?>
                        </tbody>
