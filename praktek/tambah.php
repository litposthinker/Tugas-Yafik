<?php
require 'koneksi.php';
$sql = "SELECT `foto`, nama, kelamin, negara, email, skill FROM orang";
                ...
                <section class="section">
                    <div class="section-header">
                        ...
                        <div class="section-header-breadcrumb">
                            ...
                            <div class="breadcrumb-item">Tambah Data Pelamar</div>
                        </div>
                    </div>
                                        ...
                                        <form action="simpan.php" method="POST">
                                            <div class="form-row">
                                                ...
                                                <div class="form-group col-md-6">
                                                    ...
                                                    <input type="text" class="form-control" name="tempat_tgl" placeholder="Tempat dan Tanggal Lahir">
                                                </div>
                                            </div>
                                            <div class="form-row">
                                            ...
                                            <div class="form-row">
                                                ...
                                                <div class="form-group col-md-6">
                                                    <label>Skill</label>
                                                    <input type="text" class="form-control" name="skill"></input>
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <label for="inputZip">URL Foto Profile</label>
                                                <input type="text" name="foto" class="form-control" placeholder="Link URL Gambar">
                                            </div>
                                    </div>
